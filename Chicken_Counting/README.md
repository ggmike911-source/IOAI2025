...
|:---------:|:---------------------:|:-----:|:------------:|:------------:|:----------:|:----------:|:--------:|
| Adam | 1e-4 (0.0001) | 1e-5 (0.00001) | 1e-4 (0.0001) | 20 | 8 | 10 minutes | 0.69020 |
...
This version only adjusted the hyperparameters, though it is not very efficient and even less accurate than the baseline model.
